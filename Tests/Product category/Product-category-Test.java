...
public class ProductcategoryTest {
  ...
  public void productcategoryempty() {
    ...
    // 9 | assertElementPresent | id=alertCategory |  | 
    {
      List<WebElement> elements = driver.findElements(By.id("alertCategory"));
  ...
  public void productcategoryfilled() {
    ...
    // 8 | click | id=inputCondition |  | 
    driver.findElement(By.id("inputCondition")).click();
    // 9 | click | id=btnAdd |  | 
    driver.findElement(By.id("btnAdd")).click();
    // 10 | mouseOver | id=btnAdd |  | 
    {
      WebElement element = driver.findElement(By.id("btnAdd"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    // 11 | mouseOut | id=btnAdd |  | 
    {
