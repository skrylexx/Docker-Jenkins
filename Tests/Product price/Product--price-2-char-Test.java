...
import java.net.URL;
public class Productprice2charTest {
  ...
  @Test
  public void productprice2char() {
    // Test name: Product-price-2-char-
    ...
    // 4 | type | id=inputName | Aaazzzeeerrrtttyyy | 
    driver.findElement(By.id("inputName")).sendKeys("Aaazzzeeerrrtttyyy");
    // 5 | click | id=inputPrice |  | 
    driver.findElement(By.id("inputPrice")).click();
    // 6 | type | id=inputPrice | 20 | 
    driver.findElement(By.id("inputPrice")).sendKeys("20");
    // 7 | click | id=btnAdd |  | 
