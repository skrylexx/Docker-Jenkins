...
import java.net.URL;
public class ProductnamewithintegersTest {
  ...
  @Test
  public void productnamewithintegers() {
    // Test name: Product name with integers
    ...
    // 4 | type | id=inputName | Une 2 3 | 
    driver.findElement(By.id("inputName")).sendKeys("Une 2 3");
    // 5 | click | id=inputPrice |  | 
    driver.findElement(By.id("inputPrice")).click();
    // 6 | type | id=inputPrice | 123 | 
    driver.findElement(By.id("inputPrice")).sendKeys("123");
    ...
    // 10 | select | id=inputCondition | label=Excellent | 
    {
